...
class HeadClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path.quadraticBezierTo(
        size.width / 3, size.height - 70, size.width / 2, size.height - 60);
    path.quadraticBezierTo(
        2 / 8 * size.width, size.height, size.width, size.height - 30);
            ...
            children: [
              ClipPath(
                ...
                child: Container(
                  ...
                  height: 300,
                  decoration: const BoxDecoration(
                    color: Color.fromARGB(160, 71, 71, 71),
              ...
              Container(
                padding:
                    const EdgeInsets.only(top: 60, left: 20.0, right: 20.0),
